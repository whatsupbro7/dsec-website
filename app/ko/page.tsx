export default function KoreanHome() {
  const strengths = [
    ...
    ["생산 역량", "와이어 하네스와 전기 부품 조립을 중심으로 안정적인 생산체계를 운영합니다."],
    ...
    <>
          ...
          <div className="relative z-10 flex items-center px-6 py-20 sm:px-10 lg:px-16 xl:px-24">
            <div className="max-w-xl">
              ...
              <p className="mt-6 text-lg leading-8 text-slate-600">
                대성전자는 와이어 하네스와 전기 부품을 전문적으로 생산하며, 품질과 안정적인 생산을 바탕으로 고객과의 장기적인 파트너십을 만들어갑니다.
              </p>
      ...
      <section className="border-y border-slate-200 bg-slate-50 px-6 py-10">
        <div className="mx-auto grid max-w-7xl gap-5 sm:grid-cols-2 lg:grid-cols-5">
          <a href="/ko/products" className="group overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
            <div className="h-36 overflow-hidden bg-white"><img src="/images/products/wire-harness-products.jpg" alt="와이어 하네스 제품" className="h-full w-full object-contain transition duration-300 group-hover:scale-105" /></div>
          ...
          <a href="/ko/products" className="group overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
            <div className="h-36 overflow-hidden bg-white"><img src="/images/products/products.png" alt="전기 부품" className="h-full w-full object-cover object-center transition duration-300 group-hover:scale-105" /></div>
            <div className="p-5"><h2 className="font-bold text-slate-950">Electrical Components</h2><p className="mt-1 text-sm text-slate-500">전기 부품</p></div>
          </a>
      ...
      <section className="bg-white px-6 py-24">
        <div className="mx-auto max-w-6xl text-center">
          ...
          <div className="mt-14 overflow-hidden rounded-3xl border border-slate-200 bg-white p-3 shadow-sm"><img src="/images/products/products.png" alt="대성전자 와이어 하네스 및 전기 부품 제품 포트폴리오" className="h-auto w-full rounded-2xl object-contain" /></div>
