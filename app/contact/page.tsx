...
export default function Contact() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    } catch (err) { setError(err instanceof Error ? err.message : "We could not send your inquiry. Please try again later."); }
