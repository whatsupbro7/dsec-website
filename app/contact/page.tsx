...
export default function Contact() {
  ...
  return (
    <main className="min-h-screen bg-white text-slate-800">
      ...
      <section className="px-6 py-24"><div className="mx-auto max-w-6xl"><p className="text-sm font-semibold tracking-[0.25em] text-green-700">CONTACT US</p><h2 className="mt-4 text-4xl font-bold text-slate-900 md:text-5xl">Let&apos;s Work Together</h2><p className="mt-6 max-w-3xl text-lg leading-8 text-slate-600">Please contact us for product inquiries, quotations, manufacturing partnerships or any other business questions.</p><div className="mt-14 grid gap-6 md:grid-cols-3"><div className="rounded-2xl border border-slate-200 p-8 transition hover:shadow-md"><p className="text-sm font-semibold tracking-[0.2em] text-green-700">LOCATION</p><h3 className="mt-5 text-2xl font-bold text-slate-900">Our Facility</h3><p className="mt-4 leading-7 text-slate-600">DAESOUNG ELECTRIC COMPONENTS<br />Indonesia</p></div><div className="rounded-2xl border border-slate-200 p-8 transition hover:shadow-md"><p className="text-sm font-semibold tracking-[0.2em] text-green-700">BUSINESS</p><h3 className="mt-5 text-2xl font-bold text-slate-900">Business Inquiries</h3><p className="mt-4 leading-7 text-slate-600">Wire Harness<br />Electrical Components<br />Custom Solutions</p></div><div className="rounded-2xl border border-slate-200 p-8 transition hover:shadow-md"><p className="text-sm font-semibold tracking-[0.2em] text-green-700">INQUIRY</p><h3 className="mt-5 text-2xl font-bold text-slate-900">Request Information</h3><p className="mt-4 leading-7 text-slate-600">Contact us with your requirements and our team will review your inquiry.</p></div></div></div></section>
